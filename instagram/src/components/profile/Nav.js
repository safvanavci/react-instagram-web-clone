...
export default function Nav() {
    return (
        <div className='flex justify-center gap-14 text-gray text-sm  font-semibold'>
            ...
            <NavLink to={'saved'} className={({isActive})=> isActive ? 'border-t border-black text-black':''}>
                <div className='flex items-center py-4'>
                    <SavedIcon />
                    <p className='ml-1.5'>KAYDEDİLENLER</p>
                </div>
            </NavLink>
            <NavLink to={'tagged'} className={({isActive})=> isActive ? 'border-t border-black text-black':''}>
                <div className='flex items-center py-4'>
                    <TaggedIcon />
